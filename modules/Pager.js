...
const Events = require('./Pager/Events');
const Meta = require('./Pager/Meta');
const No = require('./Pager/No');
const Sizes = require('./Pager/Sizes');
const Template = require('./Pager/Template');
